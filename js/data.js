...
window.SITE_DATA = {
  ...
  courses: {
    es: [
      { tag:"PRIMERA VEZ", title:"Curso teórico + práctico", text:"Empieza desde cero con formación teórica y práctica.", icon:"steering", bullets:["Formación teórica","Práctica de conducción","Orientación para el proceso"], message:"Hola, quiero información sobre el curso teórico y práctico para primera licencia.", page:"servicios/primera-licencia/" },
      { tag:"LICENCIAS A / C / D", title:"Certificación y orientación", text:"Certificación y orientación para licencias particulares y comerciales.", icon:"license", bullets:["Licencia particular","Licencia comercial","Exámenes requeridos"], message:"Hola, quiero información sobre certificación para licencia A, C o D.", page:"servicios/certificacion-licencias/" },
      { tag:"AMPLIACIONES", title:"Amplía tu categoría", text:"Avanza a categorías profesionales según tu objetivo.", icon:"arrow", bullets:["E1, E2 y E3","F, G, H e I","Orientación de requisitos"], message:"Hola, quiero información sobre ampliación de licencia.", page:"servicios/ampliaciones/" },
      { tag:"TRÁMITES ESPECIALES", title:"Recuperación de licencia", text:"Orientación para procesos de licencia retenida.", icon:"shield", bullets:["Orientación personalizada","Proceso guiado","Acompañamiento"], message:"Hola, quiero orientación sobre recuperación de licencia retenida.", page:"servicios/recuperacion-licencia/" }
    ],
    en: [
      { tag:"FIRST LICENSE", title:"Theory + practical course", text:"Start from zero with theory and practical training.", icon:"steering", bullets:["Theory training","Driving practice","Process guidance"], message:"Hello, I would like information about the theory and practical course for a first license.", page:"servicios/primera-licencia/" },
      { tag:"LICENSES A / C / D", title:"Certification & guidance", text:"Certification and guidance for private and commercial licenses.", icon:"license", bullets:["Private license","Commercial license","Required exams"], message:"Hello, I would like information about certification for A, C or D licenses.", page:"servicios/certificacion-licencias/" },
      { tag:"UPGRADES", title:"Upgrade your category", text:"Move into professional categories based on your goal.", icon:"arrow", bullets:["E1, E2 and E3","F, G, H and I","Requirements guidance"], message:"Hello, I would like information about upgrading my license category.", page:"servicios/ampliaciones/" },
      { tag:"SPECIAL PROCEDURES", title:"License recovery", text:"Guidance for retained-license recovery processes.", icon:"shield", bullets:["Personalized guidance","Guided process","Support"], message:"Hello, I would like guidance about recovering a retained driver's license.", page:"servicios/recuperacion-licencia/" }
    ]
  },
