...
window.SITE_DATA = {
  ...
  courses: {
    es: [
      { tag:"PRIMERA VEZ", title:"Curso teórico + práctico", text:"Formación para quienes quieren aprender a conducir y avanzar hacia su primera licencia con una ruta clara.", icon:"steering", bullets:["Formación teórica","Práctica de conducción","Orientación para el proceso"], message:"Hola, quiero información sobre el curso teórico y práctico para primera licencia.", page:"pages/primera-licencia.html" },
      { tag:"LICENCIAS A / C / D", title:"Certificación y orientación", text:"Solicita información para certificados de licencia particular o comercial y los exámenes requeridos según tu categoría.", icon:"license", bullets:["Licencia particular","Licencia comercial","Exámenes requeridos"], message:"Hola, quiero información sobre certificación para licencia A, C o D.", page:"pages/certificacion-licencias.html" },
      { tag:"AMPLIACIONES", title:"Amplía tu categoría", text:"Opciones para conductores que buscan avanzar hacia categorías profesionales y ampliar sus posibilidades de conducción.", icon:"arrow", bullets:["E1, E2 y E3","F, G, H e I","Orientación de requisitos"], message:"Hola, quiero información sobre ampliación de licencia.", page:"pages/ampliaciones.html" },
      { tag:"TRÁMITES ESPECIALES", title:"Recuperación de licencia", text:"Orientación y acompañamiento para casos de licencia retenida, según el motivo y el proceso que corresponda.", icon:"shield", bullets:["Orientación personalizada","Proceso guiado","Acompañamiento"], message:"Hola, quiero orientación sobre recuperación de licencia retenida.", page:"pages/recuperacion-licencia.html" }
    ],
    en: [
      { tag:"FIRST LICENSE", title:"Theory + practical course", text:"Training for people who want to learn to drive and move toward their first license with a clear path.", icon:"steering", bullets:["Theory training","Driving practice","Process guidance"], message:"Hello, I would like information about the theory and practical course for a first license.", page:"pages/primera-licencia.html" },
      { tag:"LICENSES A / C / D", title:"Certification & guidance", text:"Request information about private or commercial license certificates and the exams required for your category.", icon:"license", bullets:["Private license","Commercial license","Required exams"], message:"Hello, I would like information about certification for A, C or D licenses.", page:"pages/certificacion-licencias.html" },
      { tag:"UPGRADES", title:"Upgrade your category", text:"Options for drivers who want to move into professional categories and expand their driving opportunities.", icon:"arrow", bullets:["E1, E2 and E3","F, G, H and I","Requirements guidance"], message:"Hello, I would like information about upgrading my license category.", page:"pages/ampliaciones.html" },
      { tag:"SPECIAL PROCEDURES", title:"License recovery", text:"Guidance and support for retained-license cases, according to the reason and applicable process.", icon:"shield", bullets:["Personalized guidance","Guided process","Support"], message:"Hello, I would like guidance about recovering a retained driver's license.", page:"pages/recuperacion-licencia.html" }
    ]
  },
