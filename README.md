...
- `servicios/primera-licencia/`
- `servicios/certificacion-licencias/`
- `servicios/ampliaciones/`
- `servicios/recuperacion-licencia/`
...
## URLs limpias (V3.3)
Las páginas internas usan carpetas con `index.html`, por lo que las URLs públicas no muestran `.html`. Ejemplo: `/licencias/e2/` y `/servicios/ampliaciones/`.
